...
// DeleteSynceMetrics removes all synce-related metrics for a given process and configuration.
...
// DeleteMetrics removes all metrics related to a specific process and configuration.
...
// DeleteProcessStatusMetrics removes metrics related to process status and restart counts for a specific process and configuration.
