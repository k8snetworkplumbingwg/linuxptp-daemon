...
const (
	// PTPNamespace and Subsystem for PTP metrics
	PTPNamespace = "openshift"
	// PTPSubsystem is the subsystem for PTP metrics
	PTPSubsystem = "ptp"
)

var (
	// Offset metrics to show current offset
	...
	// MaxOffset metrics to show current max offset
	...
	// FrequencyAdjustment metrics to show current frequency adjustment
	...
	// Delay metrics to show current delay
	...
	// ProcessStatus metrics to show current process status
	...
	// ProcessRestartCount metrics to show current process restart count
