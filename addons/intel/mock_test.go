...
type mockClockChain struct {
	returnDeviceCtl       *[]dpll.PinParentDeviceCtl
	returnErr             error
...
func (m *mockClockChain) EnterNormalTBC() (*[]dpll.PinParentDeviceCtl, error) {
	m.enterNormalTBCCount++
	return m.returnDeviceCtl, m.returnErr
}

func (m *mockClockChain) EnterHoldoverTBC() (*[]dpll.PinParentDeviceCtl, error) {
	m.enterHoldoverTBCCount++
	return m.returnDeviceCtl, m.returnErr
}

func (m *mockClockChain) SetPinDefaults() (*[]dpll.PinParentDeviceCtl, error) {
