...
func makeTwoParentPin(id uint32, label string, clockID uint64, eecDir, ppsDir uint32) *dpll.PinInfo {
	return &dpll.PinInfo{
		...
		ParentDevice: []dpll.PinParentDevice{
			{ParentID: 100, Direction: eecDir, Prio: toPtr[uint32](0), State: PinStateDisconnected},
			{ParentID: 200, Direction: ppsDir, Prio: toPtr[uint32](0), State: PinStateDisconnected},
		},
	}
}
...
func TestGetCommandsForPluginPinSet_InvalidValue(t *testing.T) {
	...
	for _, pc := range cmd.PinParentCtl {
		...
		assert.Equal(t, uint32(PinStateSelectable), *pc.State)
	}
}
...
func TestGetCommandsForPluginPinSet_Value0_FromConnected(t *testing.T) {
	pins := makePins(&dpll.PinInfo{
		...
		Capabilities: allPinCaps,
		ParentDevice: []dpll.PinParentDevice{
			{ParentID: 100, Direction: dpll.PinDirectionInput, Prio: toPtr[uint32](0), State: PinStateConnected},
			{ParentID: 200, Direction: dpll.PinDirectionInput, Prio: toPtr[uint32](0), State: PinStateConnected},
		},
	})
...
func TestGetCommandsForPluginPinSet_Value0_FromDisconnected(t *testing.T) {
	pins := makePins(&dpll.PinInfo{
		...
		Capabilities: allPinCaps,
		ParentDevice: []dpll.PinParentDevice{
			{ParentID: 100, Direction: dpll.PinDirectionOutput, Prio: toPtr[uint32](0), State: PinStateDisconnected},
			{ParentID: 200, Direction: dpll.PinDirectionOutput, Prio: toPtr[uint32](0), State: PinStateDisconnected},
		},
	})
	...
	for _, pc := range cmd.PinParentCtl {
		...
		assert.Equal(t, uint32(PinStateDisconnected), *pc.State)
...
func TestGetCommandsForPluginPinSet_Value2_SetOutput(t *testing.T) {
	...
	for _, pc := range dataCmd.PinParentCtl {
		...
		assert.Equal(t, uint32(PinStateConnected), *pc.State)
...
func TestSetPinControlData_StateOnlyPin(t *testing.T) {
	pin := dpll.PinInfo{
		...
		ParentDevice: []dpll.PinParentDevice{
			{ParentID: 0, Direction: dpll.PinDirectionOutput, State: PinStateConnected},
			{ParentID: 1, Direction: dpll.PinDirectionOutput, State: PinStateConnected},
		},
	}

	control := PinParentControl{
		EecOutputState: PinStateDisconnected,
		PpsOutputState: PinStateDisconnected,
	}
...
func TestSetPinControlData_StateOnlyPin_InputDirection(t *testing.T) {
	pin := dpll.PinInfo{
		...
		Capabilities: dpll.PinCapState,
		ParentDevice: []dpll.PinParentDevice{
			{ParentID: 2, Direction: dpll.PinDirectionInput, State: PinStateDisconnected},
			{ParentID: 3, Direction: dpll.PinDirectionInput, State: PinStateDisconnected},
		},
	}
...
func TestSetPinControlData_NoCaps(t *testing.T) {
	...
	control := PinParentControl{
		EecPriority:    0,
		PpsPriority:    0,
		EecOutputState: PinStateConnected,
		PpsOutputState: PinStateConnected,
	}
	cmds := SetPinControlData(pin, control)
	assert.Len(t, cmds, 1)
	for _, pc := range cmds[0].PinParentCtl {
...
func TestSetPinControlData_PrioCapButNilPrio(t *testing.T) {
	pin := dpll.PinInfo{
		...
		ParentDevice: []dpll.PinParentDevice{
			{ParentID: 4, Direction: dpll.PinDirectionInput, State: PinStateDisconnected},
			{ParentID: 5, Direction: dpll.PinDirectionInput, State: PinStateDisconnected},
		},
	}
